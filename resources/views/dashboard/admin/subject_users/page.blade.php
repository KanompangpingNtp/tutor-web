                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <form action="{{ route('SubjectUsersDelete', $subjectUser->id) }}" method="POST" onsubmit="return confirm('คุณแน่ใจว่าต้องการลบหรือไม่?')">
                                            @csrf
                                            @method('DELETE')
                                ...
                                <form action="{{ route('SubjectUsersUpdate', $subjectUser->id) }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="user_id" required>
                                            @foreach($users as $user)
                                                <option value="{{ $user->id }}" {{ $user->id == $subjectUser->user_id ? 'selected' : '' }}>
